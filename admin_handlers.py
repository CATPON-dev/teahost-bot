...
async def cmd_help(message: types.Message):
    text = (
        ...
        "<blockquote><b>👤 Управление ботом и пользователями</b></blockquote>\n"
        "<code>/help</code> (<i>Админ</i>)\n"
        "<i>- Показать это сообщение.</i>\n\n"
        "<code>/ban &lt;ID|@&gt;</code> (<i>Супер Админ</i>)\n"
        "<i>- Заблокировать пользователя.</i>\n\n"
        "<code>/unban &lt;ID|@&gt;</code> (<i>Супер Админ</i>)\n"
        "<i>- Разблокировать пользователя.</i>\n\n"
        "<code>/users</code> (<i>Админ</i>)\n"
        "<i>- Постраничный список пользователей.</i>\n\n"
        "<code>/user &lt;ID|@&gt;</code> (<i>Админ</i>)\n"
        "<i>- Инфо и управление пользователем.</i>\n\n"
        "<code>/server &lt;on|off&gt;</code> (<i>Супер Админ</i>)\n"
        "<i>- Включить/выключить тех. работы.</i>\n\n"
        "<code>/restart</code> (<i>Супер Админ</i>)\n"
        "<i>- Перезапустить бота.</i>\n\n"
        "<code>/stop</code> (<i>Супер Админ</i>)\n"
        "<i>- Остановить процесс бота.</i>\n\n"

        "<blockquote><b>🖥️ Управление серверами и хостами</b></blockquote>\n"
        "<code>/serv help</code> (<i>Супер Админ</i>)\n"
        "<i>- Справка по командам управления серверами.</i>\n\n"
        "<code>/terminal [код] &lt;команда&gt;</code> (<i>Супер Админ</i>)\n"
        "<i>- Выполнить команду на хост-сервере.</i>\n\n"
        "<code>/obs</code> (<i>Супер Админ</i>)\n"
        "<i>- Обслужить все удаленные серверы.</i>\n\n"
        "<code>/set_api_token &lt;IP&gt; &lt;токен&gt;</code> (<i>Супер Админ</i>)\n"
        "<i>- Установить API токен для сервера.</i>\n\n"
        "<code>/set_api_url &lt;IP&gt; &lt;URL&gt;</code> (<i>Супер Админ</i>)\n"
        "<i>- Установить API URL для сервера.</i>\n\n"
        "<code>/show_api_config</code> (<i>Супер Админ</i>)\n"
        "<i>- Показать текущую API конфигурацию.</i>\n\n"
        
        "<blockquote><b>🐳 Управление контейнерами</b></blockquote>\n"
        "<code>/container list</code> (<i>Супер Админ</i>)\n"
        "<i>- Список всех контейнеров.</i>\n\n"
        "<code>/container exec &lt;имя&gt; &lt;команда&gt;</code> (<i>Супер Админ</i>)\n"
        "<i>- Выполнить команду внутри контейнера.</i>\n\n"
        "<code>/exec_all &lt;код&gt; &lt;команда&gt;</code> (<i>Супер Админ</i>)\n"
        ...
        "<blockquote><b>📊 Статистика и мониторинг</b></blockquote>\n"
        "<code>/serverinfo</code> (<i>Админ</i>)\n"
        "<i>- Интерактивный мониторинг серверов.</i>\n\n"
        "<code>/stats</code> (<i>Супер Админ</i>)\n"
        "<i>- Расширенная статистика по боту.</i>\n\n"
        "<code>/cpu_ub</code> (<i>Админ</i>)\n"
        "<i>- Нагрузка на CPU по юзерботам.</i>\n\n"
        "<code>/check</code> (<i>Супер Админ</i>)\n"
        "<i>- Проверка наличия сессий на серверах.</i>\n\n"

        "<blockquote><b>🚀 Разное</b></blockquote>\n"
        "<code>/bc [ID|@]</code> (<i>Супер Админ</i>)\n"
        "<i>- Рассылка сообщений (ответом на сообщение).</i>\n\n"
        "<code>/update &lt;текст&gt;</code> (<i>Супер Админ</i>)\n"
        "<i>- Опубликовать коммит в канал.</i>\n\n"
        "<code>/git &lt;команда&gt;</code> (<i>Супер Админ</i>)\n"
        "<i>- Управление Git-репозиторием бота.</i>\n\n"
