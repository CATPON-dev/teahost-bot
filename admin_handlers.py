...
async def cmd_ahelp(message: types.Message):
    text = (
        ...
        "<code>/admin &lt;add|del&gt; &lt;admin|super&gt; ...</code> (<i>Супер Админ</i>)\n"
        "<i>- Управление правами администраторов.</i>\n\n"
        ...
        "<code>/deluser_db &lt;ID|@&gt;</code> (<i>Супер Админ</i>)\n"
        "<i>- Полное удаление пользователя из БД.</i>\n\n"
        ...
        "<i>- Справка по управлению серверами.</i>\n\n"
